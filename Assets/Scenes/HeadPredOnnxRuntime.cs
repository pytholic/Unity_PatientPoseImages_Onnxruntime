...
public class HeadPredOnnxRuntime : MonoBehaviour
{
    ...
    private async void Start()
    {
        ...
        // OnnxMesh.SaveTensor(input, @"/home/trojan/Desktop/input.txt");
        // Debug.Log($"{input[0, 0, 0, 0]}, {input[0, 0, 0, 1]}, {input[0, 0 ,0, 2]}, ");
        ...
        using (var session = new InferenceSession(modelPath, options))
        {
            ...
            Debug.Log($"input shape is ({n}, {w}, {c})"); // should return (-1, 2048, 3)
